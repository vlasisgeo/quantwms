"""
Django settings for qwms project.
...
SECRET_KEY = 'django-insecure-cmn74%e4z$0pxyycrw#kdq5n4_1&xu*7obgd)+!yh=m8-l#fp*'
...
WSGI_APPLICATION = 'qwms.wsgi.application'
