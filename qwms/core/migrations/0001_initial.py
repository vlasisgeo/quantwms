    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('active', models.BooleanField(default=True)),
                ('is_refrigerated', models.BooleanField(default=False, help_text='If true, this Section is temperature-controlled (refrigerated) and can store perishable items.')),
