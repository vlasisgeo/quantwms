...
export default function Bins() {
  ...
  const [modalType, setModalType] = useState<null | 'single' | 'mass'>(null)
      ...
      <Card>
        ...
        <CardContent className="p-0">
          <Table
            ...
            data={data?.results ?? []}
            columns={[
              { key: 'location_code', header: 'Location Code', render: (r) => <span className="font-mono font-medium">{r.location_code}</span> },
